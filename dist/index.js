'use strict';var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src/index.js';/**
 * react-native-swiper
...
var _react=require('react');var _react2=_interopRequireDefault(_react);var _reactNative=require('react-native');var _reactNative2=_interopRequireDefault(_reactNative);var _reactTimerMixin=require('react-timer-mixin');var _reactTimerMixin2=_interopRequireDefault(_reactTimerMixin);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var _Dimensions$get=

_reactNative.Dimensions.get('window');var width=_Dimensions$get.width;var height=_Dimensions$get.height;
...
module.exports=_react2.default.createClass({displayName:'exports',
...
/**
   * Automatic rolling
   */
autoplay:function autoplay(){var _this=this;
if(
...
if(
!_this.props.loop&&(
_this.props.autoplayDirection?
_this.state.index===_this.state.total-1:
_this.state.index===0))
...
/**
   ...
   */
onScrollBegin:function onScrollBegin(e){var _this2=this;
// update scroll state
...
/**
   ...
   * @param  {object} e native event
   */
onScrollEnd:function onScrollEnd(e){var _this3=this;
// update scroll state
this.setState({
isScrolling:false});
...
/*
   ...
   * @param {object} e native event
   */
onScrollEndDrag:function onScrollEndDrag(e){var
contentOffset=e.nativeEvent.contentOffset;var _props=
this.props;var horizontal=_props.horizontal;var children=_props.children;var _state=
this.state;var offset=_state.offset;var index=_state.index;
...
_react2.default.cloneElement(ActiveDot,{key:i}):

_react2.default.cloneElement(Dot,{key:i}));
